        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KlasId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Docenten",
                columns: new[] { "Id", "IdentityUserId", "Naam" },
                values: new object[,]
                {
                    { 1, null, "Daniël Dedden" },
                    { 2, null, "Jan de Boer" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Leerlingen",
                columns: new[] { "Id", "IdentityUserId", "KlasId", "Naam", "Niveau" },
                values: new object[,]
                {
                    { 1, "", 1, "Anna Jansen", 1 },
                    { 2, "", 1, "Bram de Vries", 2 },
